    ...
    */
    ...
    <div class="container div-top decoration-none" style="border: 0px solid red;">
        ...
        <div id="" class="col-md-9  div-margin-top article-container" style="border : 0px solid blue;">
            <div class="article-pic text-center" style="border : 0px solid black;"><img src="{{ asset('img/news/29906170001_3624585928001_Screen-Shot-2014-06-16-at-4-44-20-AM.jpg') }}"></div>
