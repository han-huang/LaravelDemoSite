    ...
    public static function display()
    {
        ...
        foreach ($parentItems as $item) {
            ...
            if ($children_menu_items->count() > 0) {
                ...
                $output .= '<a href="'.$item->url.'" class="dropdown-toggle" data-toggle="dropdown" role="button" ';
                $output .= 'aria-haspopup="true" aria-expanded="false">'.$item->title.'<span class="caret"></span></a>';
    ...
    public static function buildSubmenu($menuItems, $parentId, $parentUrl = null)
    {
        ...
        foreach ($parentItems as $item) {
            ...
            if ($children_menu_items->count() > 0) {
                ...
                $output .= '<a href="'.$item->url.'" class="dropdown-toggle" data-toggle="dropdown" ';
                $output .= 'aria-haspopup="true" aria-expanded="false">'.$item->title.'</a>';
